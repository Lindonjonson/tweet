  ...
  <div class="topo-publicacoes w-clearfix">
    ...
    <div class="div-feed">
      <div class="container-publicacoes">
        ...
        @foreach ($ttSeguindos as $ttSeguindo)  

        @if($contaComentarioTotal >=1)
         
              
          
          <div class="div-publicacao-feed">{{$ttSeguindo->name}}:
            <p class="texto-publicacao">{{$ttSeguindo->conteudo}}</p>
             ...
             @if ($ttSeguindo->id == $comentario->id)
            ...
            <div class="w-form">
              <form id="email-form-2" name="email-form-2" data-name="Email Form 2" class="w-clearfix" action="{{route('comentario.create',['Post' => $ttSeguindo->id ])}}" method="post">
                @csrf
